                  ...
                  >
                    ...
                    <div className="p-4 flex justify-between items-center bg-white">
                      ...
                      <div className="text-right">
                        {hasSale ? (
                          <div>
                            <span className="text-xs text-gray-400 line-through block">${Number(product.price).toFixed(2)}</span>
                            <span className="text-sm font-bold text-red-600">${Number(product.sale_price).toFixed(2)}</span>
                          </div>
                        ) : (
                          <p className="text-sm font-medium text-[#D98C7A]">${Number(product.price).toFixed(2)}</p>
                        )}
                      </div>
                    </div>
                  </Link>
