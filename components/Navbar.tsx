  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white border-b border-[#F3D9CE]">
        ...
        {/* Main Navigation Bar */}
        <nav className="h-20 px-6 md:px-8 bg-white">
          ...
          {/* MOBILE LAYOUT (App-Style Flexbox) */}
          <div className="md:hidden flex justify-between items-center h-full w-full">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="text-[#2E2624] hover:opacity-75 transition-opacity py-1.5 pr-1.5 -ml-1.5 flex items-center justify-center cursor-pointer"
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/cart" className="flex items-center gap-1 font-bold text-[#D98C7A] hover:text-[#2E2624] transition-colors cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>
      ...
      {/* Smooth Left Slide-in Menu Drawer (For Mobile Only) */}
